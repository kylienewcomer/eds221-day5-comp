...
# populate matrtix with the fish years in row 1
proj_year[1, ] <- fish_year0

# crating a loop that multiplies the population by the leslie matrix to produce preceding population; i - 1 to reference previous row
...
#updating column names for population stages
